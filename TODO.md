...
- add JSON schema
- adapt documentation
- hyphenate text only by using parse5 lib or such in order to avoid adding hypens to html tags

# TODO next

- create kpfonts NPM package to avoid having to copy it to project sources
  - https://www.npmjs.com/package/@textbrocken/cv
...
- pupeteer is huge (+300MB), gosh
  ...
  - or https://libpdf.documenso.com/docs/getting-started/create-pdf
  - or simply use AI?
- consider indentation: https://jsfiddle.net/yrw4pbvq/3/
